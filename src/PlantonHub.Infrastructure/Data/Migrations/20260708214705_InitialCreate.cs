    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserClinicRoles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserClinicRoles_Clinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "Clinics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserClinicRoles_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckInDeviceId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ...
                    CheckOutDeviceId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserClinicRoles_ClinicId",
                table: "UserClinicRoles",
                column: "ClinicId");

            migrationBuilder.CreateIndex(
                name: "IX_UserClinicRoles_UserId_ClinicId_Role",
                table: "UserClinicRoles",
                columns: new[] { "UserId", "ClinicId", "Role" },
                unique: true);

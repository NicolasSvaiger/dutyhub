...
namespace PlantonHub.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260731030512_AddSelfRegistrationStatus")]
    partial class AddSelfRegistrationStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlantonHub.Domain.Entities.UserPublicOrganRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "PublicOrganId")
                        .IsUnique()
                        .HasDatabaseName("IX_UserPublicOrganRole_UserId_PublicOrganId");

                    b.ToTable("UserPublicOrganRoles");
                });
